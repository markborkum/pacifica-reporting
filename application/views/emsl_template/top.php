...
<div id="subBanner" style="position:relative;">
  ...
  <div class="banner_bar_background">
    <div class="banner_bar banner_bar_left banner_bar_<?php echo $this->site_color ?>">
      <div class='user_login_info'>Signed in as: <?php echo $logged_in_user ?></div>
    </div>
    <div class="banner_bar banner_bar_right banner_bar_grey">
      <div id="site_label">MyEMSL Reporting</div>
      <div id="last_update_timestamp" class="last_update_timestamp" style="">Last Source Update: <?php echo $this->last_update_time->format('n/j/Y g:i a') ?></div>
    ...
    <?php else: ?>
    <div class='user_login_info'>Signed in as: <?php echo $logged_in_user ?></div>
    <img src="<?php echo $banner_path ?>" <?php echo $banner_dimensions?> alt="" />
    <?php endif; ?>
</div>
