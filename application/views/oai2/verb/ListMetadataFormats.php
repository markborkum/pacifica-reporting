...
$ListMetadataFormats = $root->addChild('ListMetadataFormats', NULL, $NS_OAI_2_0);

foreach ($oai2['metadataFormat'] as $array_for_metadataFormat) {
  addChildren($ListMetadataFormats->addChild('metadataFormat', NULL, $NS_OAI_2_0), array(
    'metadataPrefix' => NULL,
    'schema' => NULL,
    'metadataNamespace' => NULL,
  ), $array_for_rightsManifest, $NS_OAI_2_0);
}
